...
class test_Ast_Module(TestCase):
    ...
    def test_all_nodes__an_class(self):
        ...
        assert ast_module.stats() == {'node_types': {'Ast_Module': 1, 'Ast_Class_Def': 1, 'Ast_Name': 12, 'Ast_Function_Def': 2, 'Ast_Load': 12,
                                      ...
                                      'ast_types' : {'Module': 1, 'ClassDef': 1, 'Name': 12, 'FunctionDef': 2, 'Load': 12, 'arguments': 2,
    ...
    def test_all_nodes__in_source_code(self):
        ...
        print('')
        assert type(module) is ast.Module
        assert ast_module.stats() == {'node_types': {'Ast_Module': 1, 'Ast_Expr': 179, 'Ast_Import': 10, 'Ast_Import_From': 4, 'Ast_Assign': 212, 'Ast_Class_Def': 12,
                                      ...
                                      'ast_types'    : {'Module': 1, 'Expr': 179, 'Import': 10, 'ImportFrom': 4, 'Assign': 212, 'ClassDef': 12, 'FunctionDef': 109, 'Constant': 356,
