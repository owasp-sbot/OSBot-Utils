    ...
    def test_print_lines(self):
        ...
        with patch('builtins.print') as builtins_print:
            ...
            assert builtins_print.call_args_list == [call('┌─────┬──────┬───────┬───────────────────────────────────────────────┬────────────────────────────────────────────────────┬──────┐   '),
                                                     ...
                                                     call('├─────┼──────┼───────┼───────────────────────────────────────────────┼────────────────────────────────────────────────────┼──────┤   '),
                                                     call('│ \x1b[90m1\x1b[0m   │   25 │     1 │ test_Trace_Call__Print_Lines.an_method        │   \x1b[1m\x1b[92mdef an_method():\x1b[0m                                 │      │'),
                                                     ...
                                                     call('│ \x1b[90m3\x1b[0m   │  387 │     2 │ osbot_utils.utils.Files.temp_folder_current   │     \x1b[1m\x1b[92mdef temp_folder_current():\x1b[0m                     │      │'),
                                                     ...
                                                     call('│ \x1b[90m6\x1b[0m   │  387 │     2 │ osbot_utils.utils.Files.temp_folder_current   │     \x1b[1m\x1b[92mdef temp_folder_current():\x1b[0m                     │      │'),
                                                     ...
                                                     call('│ \x1b[90m8\x1b[0m   │  166 │     2 │ osbot_utils.utils.Files.folder_exists         │     \x1b[1m\x1b[92mdef folder_exists(path):\x1b[0m                       │      │'),
                                                     ...
                                                     call('│ \x1b[90m10\x1b[0m  │  264 │     3 │ osbot_utils.utils.Files.is_folder             │       \x1b[1m\x1b[92mdef is_folder(target):\x1b[0m                       │      │'),
