...
qualname__original = 'SSH.execute_command'
...
class test_TestCase__SSH(TestCase__SSH):
    ...
    @classmethod
    def setUpClass(cls):
        assert SSH.execute_command.__qualname__ == qualname__original
        super().setUpClass()
        assert SSH.execute_command.__qualname__ == qualname__patched
