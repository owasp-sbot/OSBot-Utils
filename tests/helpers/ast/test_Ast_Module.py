...
class test_Ast_Module(TestCase):
    ...
    def test_all_nodes__in_source_code(self):
        ...
        assert type(module) is ast.Module
        assert ast_module.stats() == {'all_keys'      : { 'name': 164, 'value': 372, 'asname': 18, 'attr': 430, 'arg': 300, 'cause': 25, 'type': 1, 'exc': 1, 'optional_vars': 6, 'is_async': 4, 'step': 1, 'level': 4,'module': 4},
                                      'all_values'    : { '_log': 2, 'util': 1,'SkipTest': 1, '_ShouldStop': 1, '_UnexpectedSuccess': 1, '_Outcome': 1, '_id': 1, 'addModuleCleanup': 1, 'doModuleCleanups': 1, 'skip': 1, 'skipIf': 1, 'skipUnless': 1, 'expectedFailure': 7, '_is_subtype': 1,
                                                          '_BaseTestCaseContext': 1, '_AssertRaisesBaseCon': 1, '_AssertRaisesContext': 1, '_AssertWarnsContext': 1, '_OrderedChainMap': 1, 'TestCase': 1, 'FunctionTestCase': 1, '_SubTest': 1, 'Test case implementa': 1, None: 199,
                                                          ...
                                                          '_count_diff_hashable': 1, '_common_shorten_repr': 1, 1: 20 , 'Diff is %s characte': 1, '__init__': 9, 'testPartExecutor': 6, 'decorator': 1, '_raiseFailure': 7, 'handle': 5, '__enter__': 3, '__exit__': 3,
