...
class Test_Kwargs_To_Self(TestCase):
    ...
    def test__check_type_safety_assignments__on_ctor(self):
        an_bool_value = True
        an_int_value  = 42
    ...
    def test__check_type_safety_assignments____on_ctor__union(self):
        an_bool_value = True
        an_int_value  = 42
        an_str_value  = 'an_str_value'
    ...
    def test__check_type_safety_assignments__on_obj(self):
        an_bool_value = True
        an_int_value  = 42
        an_str_value  = 'an_str_value'
