...
from osbot_utils.type_safe.primitives.domains.common.safe_str.Safe_Str__Text__Dangerous import Safe_Str__Text__Dangerous, TYPE_SAFE_STR__TEXT__DANGEROUS__MAX_LENGTH
...
class test_Safe_Str__Text__Dangerous(TestCase):
    ...
    def test_Safe_Str__Text_class(self):
        ...
        assert f"in Safe_Str__Text__Dangerous, value exceeds maximum length of {TYPE_SAFE_STR__TEXT__DANGEROUS__MAX_LENGTH}" in str(exc_info.value)
