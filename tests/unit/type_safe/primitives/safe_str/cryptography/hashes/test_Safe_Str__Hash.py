...
class test_Safe_Str__Hash(TestCase):
    ...
    def test_invalid_values(self):
        ...
        # Wrong length
        with pytest.raises(ValueError, match=f"Value must be exactly {SIZE__VALUE_HASH} characters long") as exc_info:
        ...
        # Whitespace only
        with pytest.raises(ValueError, match=f"Value cannot be empty when allow_empty is False") as exc_info:
            Safe_Str__Hash('   ')
