...
class test_Zip_Bytes(TestCase):
    ...
    def test_add_folder(self):
        with Zip_Bytes() as _:
            ...
            assert _.size()                                                   == 21
            assert len(files_list(base_folder, pattern="decorators/**/*.py")) == 26 # todo: figure out why these are not the same any more (this happened when a couple extra decorators files were added) (namely the flow and task decorators)
