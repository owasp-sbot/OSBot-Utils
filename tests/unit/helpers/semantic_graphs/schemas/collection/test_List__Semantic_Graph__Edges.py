...
class test_List__Semantic_Graph__Edges(TestCase):                                    # Test edge list collection
    ...
    def test__iteration(self):                                                       # Test iteration over edges
        with graph_ids_for_tests():
            with List__Semantic_Graph__Edges() as _:
                edge1 = Schema__Semantic_Graph__Edge(edge_id=Edge_Id(Obj_Id()), from_node=Node_Id(Obj_Id()),
                                                     verb=Safe_Str__Ontology__Verb('has'), to_node=Node_Id(Obj_Id()))
                edge2 = Schema__Semantic_Graph__Edge(edge_id=Edge_Id(Obj_Id()), from_node=Node_Id(Obj_Id()),
                                                     verb=Safe_Str__Ontology__Verb('calls'), to_node=Node_Id(Obj_Id()))
                _.append(edge1)
                _.append(edge2)
