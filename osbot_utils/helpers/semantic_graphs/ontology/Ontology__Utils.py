...
#   - Node types now use node_type_id (not embedded relationships)
#   - Predicates are first-class entities with predicate_id
#   - Edge rules define valid connections at ontology level
# ═══════════════════════════════════════════════════════════════════════════════
...
class Ontology__Utils(Type_Safe):                                                      # Operations on ontology schemas
    ...
    def create_predicate_pair(self                                  ,
                              ...
                              description   : Safe_Str__Text   = None,
                              inverse_desc  : Safe_Str__Text   = None,
