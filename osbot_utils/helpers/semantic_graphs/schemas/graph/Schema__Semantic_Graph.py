...
#   - ontology_ref, rule_set_ref: References to definitions
# ═══════════════════════════════════════════════════════════════════════════════
...
class Schema__Semantic_Graph(Type_Safe):                                             # Complete semantic graph instance
    ...
    ontology_ref     : Ontology_Ref                                                  # Reference to ontology definition
    rule_set_ref     : Rule_Set_Ref                                                  # Reference to rule set (optional)
