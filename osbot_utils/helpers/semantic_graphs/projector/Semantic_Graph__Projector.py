...
class Semantic_Graph__Projector(Type_Safe):                                          # Schema__ → Projected__ transformer
    ...
    def build_references(self                ,
                         ...
                         predicate_id_to_ref : dict) -> Schema__Projected__References:
        ...
        return Schema__Projected__References(nodes = nodes_dict,
                                     edges = edges_dict)

    def build_sources(self, graph: Schema__Semantic_Graph, ontology) -> Schema__Projected__Sources:
